...
function App() {
  ...
  async function getDataByTitle() {
    ...
    if (title) {
      try {
        // const res = await fetch(`${baseURL}/blogs?title=${title}`);

        let url = new URL(`${baseURL}/blogs`);
  ...
  async function deleteAllData() {
    try {
      const res = await fetch(`${baseURL}/blogs`, { method: "delete" });
  ...
  return (
	...
	<nav className="navbar navbar-expand navbar-dark bg-info">
      ...
      <div className="card mt-3">
        <div className="card-header">React Fetch PUT </div>
        <div className="card-body">
          <div className="form-group">
      ...
      <div className="card mt-3">
        <div className="card-header">React Fetch DELETE </div>
        <div className="card-body">
          <div className="input-group input-group-sm">
	 ...
	 <div className="container mt-3">
		   <p className="text-center">React Fetch example tutorial <a href="https://github.com/kabirul" target="_blank" rel="noopener noreferrer">amica.</a></p>
		</div>
	 </div>	
  );
}
